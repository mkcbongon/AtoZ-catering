<?= $this->include('temp/user_head') ?>
<body>
<?= $this->include('temp/user_header') ?>
      ...
      <div class="services_section layout_padding">
         <div class="container">
            ...
            <p class="many_taital">There are many variations to choose from</p>
            <div class="services_section2 layout_padding">
               <div class="row">
                  <div class="col-lg-3 col-sm-6">
                     <div class="icon_1"><img src="images/icon-1.png"></div>
                     <h2 class="furnitures_text">Wedding</h2>
                  ...
                  <div class="col-lg-3 col-sm-6">
                     ...
                     <h2 class="furnitures_text">Birthday</h2>
                     <p class="dummy_text">There are many variations of passages of Lorem Ipsum available, but the</p>
                     <div class="read_bt_main">
                        <div class="read_bt"><a href="#">Read More</a></div>
                     </div>
                  ...
                  <div class="col-lg-3 col-sm-6">
                     ...
                     <h2 class="furnitures_text">Debut</h2>
                     <p class="dummy_text">There are many variations of passages of Lorem Ipsum available, but the</p>
                     <div class="read_bt_main">
                        <div class="read_bt"><a href="#">Read More</a></div>
                     </div>
                  ...
                  <div class="col-lg-3 col-sm-6">
                     ...
                     <h2 class="furnitures_text">Others</h2>
                     <p class="dummy_text">There are many variations of passages of Lorem Ipsum available, but the</p>
                     <div class="read_bt_main">
                        <div class="read_bt"><a href="#">Read More</a></div>
                     </div>
         ...
         <div class="container">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
               ...
               <div class="carousel-inner">
                  ...
                  <div class="carousel-item">
                     <h1 class="client_text">Reviews from our clients</h1>
                     <p class="ipsum_text">Lorem ipsum dolor sit amet, consectetur adipiscing</p>
                     <div class="clients_section2 layout_padding">
                        <div class="client_1">
                           <div class="row">
