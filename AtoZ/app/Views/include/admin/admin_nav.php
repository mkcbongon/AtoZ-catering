<nav class="main-header navbar navbar-expand navbar-light" style="background-color: #FEA116">
    <!-- Left navbar links -->
    <ul class="navbar-nav text-black">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link text-black" >Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
    ...
    <ul class="navbar-nav ml-auto">
      <!-- Navbar Search -->
      <li class="nav-item">
        <a class="nav-link text-black" data-widget="navbar-search" href="#" role="button">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          <i class="far fa-comments text-black"></i>
