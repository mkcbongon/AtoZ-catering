...
<head>
    ...
    <!-- user -->
    <!-- Favicon -->
    <link href="<?=base_url('user/img/favicon.ico');?>" rel="icon">
    ...
    <link href="<?=base_url('user/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css');?>" rel="stylesheet" />

    <!-- Customized Bootstrap Stylesheet -->
    <link href="<?=base_url('user/user_css/bootstrap.min.css');?>" rel="stylesheet">
