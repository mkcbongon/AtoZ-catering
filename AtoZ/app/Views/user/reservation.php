            ...
            <div class="row g-0">
                ...
                <div class="col-md-6 bg-dark d-flex align-items-center">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        <h5 class="section-title ff-secondary text-start text-primary fw-normal">Create</h5>
                        <h1 class="text-white mb-4">Reservation</h1>
                        <form action="<?=base_url('insert_reservation');?>" method="post">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="number" name="pax" id="" class="form-control">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        ...
                                        <label for="message">Select Package</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Special Request" name="note" id="message" style="height: 100px"></textarea>
